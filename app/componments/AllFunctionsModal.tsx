...
const imageFunctions = [
  ...
  },
  {
    ...
    label: '营业执照识别',
    intro:
      '快速精准结构化识别企业营业执照中的注册号、公司名称、地址、主体类型、法定代表人等14个关键有效字段',
  },
  {
    id: '7',
    label: '身份证识别',
    intro:
      '对身份证进行结构化识别，包括姓名、性别、民族、出生日期、地址、身份证号、有效期限、签发机关',
  },
  {
    id: '9',
    label: '银行卡识别',
    intro:
      '支持对主流银行卡6个关键字段的高精度结构化识别，包括类型、发卡机构、发卡机构代号、有效期、卡号、持有人',
  },
  {
    id: '10',
    label: '驾驶证识别',
    intro:
      '支持对驾驶证全部字段进行结构化识别，包括姓名、类型、驾驶证证号、性别、国籍、住址、出生日期、初次领证日期、准驾车型',
  },
];
